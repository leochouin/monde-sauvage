...
import { RIVER_IMAGES } from './riverImages.js';
...
export const RIVERS = [
  ...
  },
  {
    ...
    pathIds: ['Petite-Cascapedia', 'Petite-Cascapedia-2'],
  ...
  },
  {
    ...
    pathIds: ['Bonaventure', 'Bonaventure-2'],
  ...
  },
  {
    id: 18,
    slug: 'causapscal',
    name: { fr: 'Causapscal', en: 'Causapscal' },
    pathIds: ['Causapscal'],
    center: { lng: -67.22, lat: 48.35 },
    region: REGIONS.VALLEE_MATAPEDIA,
    fishTypes: [FISH_TYPES.SALMON],
    difficulty: 'intermediate',
    highlights: [
      { icon: '🐟', label: { fr: 'Saumon Atlantique', en: 'Atlantic Salmon' } },
      { icon: '🌲', label: { fr: 'Vallée de la Matapédia', en: 'Matapedia Valley' } },
    ],
    shortDescription: {
      fr: 'Affluent de la Matapédia, réputé pour son saumon et ses paysages sauvages.',
      en: 'Matapedia tributary, prized for salmon and wild scenery.',
    },
    description: 'Tributary of the Matapedia River known for Atlantic salmon and the rugged Matapedia Valley.',
    image: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&q=80',
  },
  {
    id: 19,
    ...
    pathIds: ['Matane'],
    center: { lng: -67.53, lat: 48.85 },
    region: REGIONS.HAUTE_GASPESIE,
    fishTypes: [FISH_TYPES.SALMON],
    difficulty: 'intermediate',
    highlights: [
      { icon: '🐟', label: { fr: 'Saumon Atlantique', en: 'Atlantic Salmon' } },
      { icon: '⛰️', label: { fr: 'Des Chic-Chocs au Saint-Laurent', en: 'Chic-Chocs to St. Lawrence' } },
    ],
    shortDescription: {
      fr: 'Grande rivière de la Haute-Gaspésie, célèbre pour ses remontées de saumon.',
      en: 'Major Upper-Gaspesie river, famous for its salmon runs.',
    },
    description: 'Major Haute-Gaspesie salmon river descending from the Chic-Choc mountains to the St. Lawrence.',
    image: 'https://images.unsplash.com/photo-1475113548492-b7dada4c4e8c?w=800&q=80',
  },
  {
    id: 17,
    ...
    pathIds: ['Sainte-Anne', 'Sainte-Anne-2'],
...
export const RIVER_GUIDE = RIVERS.map((r) => ({
  ...
  image: RIVER_IMAGES[r.slug] || r.image,
  confidence: 'high',
}));
...
export function getRiverGuideByPathId(pathId) {
  ...
  if (direct) {
    return {
      ...
      image: RIVER_IMAGES[direct.slug] || direct.image,
      confidence: 'high',
    };
  }
